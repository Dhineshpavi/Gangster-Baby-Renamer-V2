...
DB_NAME = os.environ.get("DB_NAME", "mongodb+srv://Aloneboy:Aloneboytg@cluster0.nmeelsr.mongodb.net/?retryWrites=true&w=majority")
DB_URL = os.environ.get("DB_URL", "4gbrenamedpbot")
